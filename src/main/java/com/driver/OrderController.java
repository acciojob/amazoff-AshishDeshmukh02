...
public class OrderController {
    ...
    public ResponseEntity<String> addOrder(@RequestBody Order order){
        ...
        if(flag==false) return new ResponseEntity<>("Order Id already exist!",HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<String> addPartner(@PathVariable String partnerId){
        ...
        Boolean flag = orderService.addPartner(partnerId);

        if(flag==false) return new ResponseEntity<>("Partner Id already exist!",HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<String> addOrderPartnerPair(@RequestParam String orderId, @RequestParam String partnerId){
        ...
        Boolean flag = orderService.addOrderPartnerPair(orderId,partnerId);
        //This is basically assigning that order to that partnerId
        if(flag==false) return new ResponseEntity<>("Order or Partner doen't exist!",HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<DeliveryPartner> getPartnerById(@PathVariable String partnerId){
        ...
        if(deliveryPartner==null) return  new ResponseEntity<>(null,HttpStatus.BAD_REQUEST);
